...
export default [
    ...
    },
    {
        ...
        collapsed: false,
        items: [
            { text: '模板语法', link: `${commonPath}/vue-01` },
            { text: '响应式基础', link: `${commonPath}/vue-02` },
            { text: '计算属性', link: `${commonPath}/vue-02` },
            { text: '类与样式绑定', link: `${commonPath}/vue-02` },
            { text: '列表渲染', link: `${commonPath}/vue-02` },
            { text: '事件处理', link: `${commonPath}/vue-02` },
            { text: '表单输入绑定', link: `${commonPath}/vue-02` },
            { text: '声明周期', link: `${commonPath}/vue-02` },
            { text: '侦听器', link: `${commonPath}/vue-02` },
            { text: '模板引用', link: `${commonPath}/vue-02` },
            { text: '组件基础', link: `${commonPath}/vue-02` },
        ]
    },
    {
        text: 'vue高级',
