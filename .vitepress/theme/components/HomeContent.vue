...
const layout = ref([
    ...
    { "w": 2, "h": 5, "i": "5", "name": "AJAX", "imgName": ajax, "address": "/knowledge-graph/frontend/ajax", "content": "AJAX（Asynchronous JavaScript and XML）是一种用于创建异步网页应用的技术。通过 AJAX，你可以在不重新加载整个网页的情况下，与服务器交换数据并更新部分网页内容。这使得网页应用能够更快速地响应用户的操作，并提供更流畅的用户体验。" },
