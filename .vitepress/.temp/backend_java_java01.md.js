...
import "minisearch";
const __pageData = JSON.parse('{"title":"Java","description":"","frontmatter":{"next":{"text":"Java 基础语法","link":"/backend/java/java02"}},"headers":[],"relativePath":"backend/java/java01.md","filePath":"backend/java/java01.md","lastUpdated":1717049326000}');
...
<span class="line"><span>*/</span></span></code></pre></div><p>使用以下命令可以提取生成帮助文档：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>javadoc -d docs -author -version -encoding utf-8 HelloWorld.java</span></span></code></pre></div>`);
