          ...
          <TransitionChild as="template">
            <DialogPanel class="dialog-panel">
              <Combobox @update:modelValue="onSelect">
                ...
                <ComboboxOptions
                  v-if="
                    props.predefinedQuestions.length > 0 && !questions.length
                  "
                  static
                ...
                >
                  <li v-if="props.predefinedQuestions.length > 0">
                    <ul class="combobox-options-container">
                      <ComboboxOption
                        v-for="action in filteredPredefinedQuestions"
                        :key="action"
                        :value="action"
                        as="template"
                        v-slot="{ active }"
                      >
                        <li class="combobox-option" :class="{ active }">
                          ...
                          <span class="combobox-options-name">{{
                            action
                          }}</span>
                        </li>
                      </ComboboxOption>
